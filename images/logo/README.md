...
This directory contains the ZC Forge Studios logo image used in the website header.
...
2. **Recommended specifications:**
   - File name: `zcForgeTransparent.jpg` (or `logo.svg` for scalable vector graphics)
...
3. **After uploading**, the logo will automatically appear in the header replacing the "ZC Forge Studios" text

## Current Setup

The website is configured to use: `images/logo/zcForgeTransparent.jpg`
